...
NUM_EPOCHS = 5  # epoch
MIN_FREQ = 5  # minimun frequency

# ==============================================================================
# 3. Data Processing
# ==============================================================================
# 0. 깨진 파일 문제 해결용 (혹시 몰라서)
...
print("코퍼스 로드 및 토큰화 중... (BPE 적용)")

tokenized_corpus = []
for label, line in train_iter:
    if len(line) > 0:
        # GPT2 BPE 토크나이징 (소문자 변환 후)
...
# word analogy
analogy("man", "king", "woman")  # Classic
analogy("bush", "president", "jobs")  # Political/Business Context
