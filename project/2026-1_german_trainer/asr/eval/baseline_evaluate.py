"""
원본 Whisper-tiny로 음성 인식 평가 (fine-tuned 모델과 비교용)
...
출력:   asr/eval/baseline_result_{human|tts}.json
...
사용법:
    python baseline_evaluate.py --data human
    python baseline_evaluate.py --data tts
"""
...
RESULT_PATH = os.path.join(BASE_DIR, f"baseline_result_{args.data}.json")
